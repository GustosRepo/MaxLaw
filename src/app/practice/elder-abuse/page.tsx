...
export const metadata = {
  title: 'Elder Abuse | Saggese & Associates',
  description: 'Representation for victims of elder abuse and neglect in nursing homes or by caretakers — we pursue accountability and compensation.'
}
