...
export default function CriminalDefenseLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <style>{`
        /* Shared practice/criminal-defense area styles + micro-interactions */
        ...
        /* Gold shimmer used on card hover */
      ...
      <main className="min-h-screen bg-gradient-to-br from-[#0e0e0e] to-[#1a1a1a] text-white font-[var(--font-inter)] py-12 relative overflow-hidden">
