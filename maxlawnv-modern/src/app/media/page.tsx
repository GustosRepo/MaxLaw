...
export default function MediaPage() {
  ...
  return (
    <>
      <Head>
        <title>Media — Saggese & Associates</title>
        <meta name="description" content="Media appearances, interviews, and press featuring The Law Offices of Saggese & Associates." />
        <style>{`
          ...
          <section className="mb-8">
            <div className="relative rounded-3xl p-6 md:p-8 bg-gradient-to-br from-white/3 to-transparent border border-white/8 shadow-lg overflow-hidden">
              ...
              <div className="relative z-10">
                <h1 className="text-2xl md:text-3xl font-['Playfair_Display'] font-bold text-[#bfa76a]">Media & Press</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <main className="md:col-span-2 space-y-6">
              ...
              <div className="rounded-2xl p-6 bg-gradient-to-br from-white/3 to-transparent border border-white/8 shadow-lg">
                <h2 className="text-2xl font-['Playfair_Display'] font-bold mb-3">Press Inquiries</h2>
